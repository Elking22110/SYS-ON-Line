    ...
    <>
      ...
      <DataLoader>
        <NotificationProvider>
          <AuthProvider>
            <div className="flex flex-col md:flex-row flex-1 w-full overflow-hidden bg-[#5235E8] md:bg-[#F3F4F9]">
              <Sidebar />
              <div className="flex-1 h-full overflow-y-auto overflow-x-hidden min-w-0 max-w-full bg-[#F3F4F9] rounded-none relative ipad-main-content ipad-pro-main-content">
                <Routes>
                  <Route path="/" element={
                    <ProtectedRoute>
                      <Dashboard />
                  ...
                  <Route path="/ink-suppliers" element={
                    <ProtectedRoute requiredPermission="manage_customers">
                      <InkSuppliers />
                    </ProtectedRoute>
                  } />
