...
async function updateSchema() {
    ...
    try {
        ...
        const queries = [
            ...
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "businessActivity" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "usualProduct" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "cliche" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "clicheWidth" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "clicheHeight" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "colorCount" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "notes" text;`,
            `ALTER TABLE public."Customer" ADD COLUMN IF NOT EXISTS "profileCliches" jsonb;`,
