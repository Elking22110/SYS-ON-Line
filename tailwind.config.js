  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 6px 20px rgba(139, 92, 246, 0.23)',
        'neon': '0 0 5px rgba(59, 130, 246, 0.5), 0 0 10px rgba(59, 130, 246, 0.3)',
        'glass': '0 8px 32px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(255, 255, 255, 0.5)'
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'glass': 'linear-gradient(135deg, rgba(255, 255, 255, 0.6) 0%, rgba(255, 255, 255, 0.3) 100%)',
        'holographic': 'linear-gradient(45deg, #f0f9ff, #e0f2fe, #bae6fd, #f0f9ff)'
      },
      backgroundSize: {
        '400%': '400% 400%'
      },
